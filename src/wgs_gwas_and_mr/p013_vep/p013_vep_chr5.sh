...
echo "--------start"
vep --input_file /share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/VEP_concat_vcfs/chr5_concat.vcf.gz \
  --format vcf \
  --output_file /share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/VEP_annotated_vcfs/chr5_annotated.vcf.gz \
  --force_overwrite \
  --fork 16 \
