...
# # 2. read vep results
# annotated_info = readRDS("/share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/vep_results/allAnnotatedChrs_info.rds")
# annotated_info[
#   , `:=`(
#     SNP= data.table::data.table::fifelse(
#       ID != "." & !is.na(ID),
#       ID,
#       Existing_variation,
#       Existing_variation
...
# annotated_info %>% dim()
# saveRDS(annotated_info,
#         file = "/share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/vep_results/allAnnotatedChrs_info_v2.rds")

# used_info= annotated_info[, .(CHR, BP, GENE, IMPACT, Consequence)]
# used_info %>% head()
# used_info %>% dim()
# saveRDS(used_info,
#         file = "/share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/vep_results/allAnnotatedChrs_info_used.rds")

# # 3. format used info
# used_info= readRDS("/share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/vep_results/allAnnotatedChrs_info_used.rds")
# data.table::setDT(used_info)
# used_info[
#   , CHR:= stringr::str_remove_all(CHR, "chr")
# ][
#   , CHR := data.table::fifelse(CHR %in% c("X", "x"), "23", CHR)
# ][
#   , CHR := data.table::fifelse(CHR %in% c("Y", "y"), "24", CHR)
# ]
# print(used_info[, .N, by = CHR])
# saveRDS(used_info,
#         file = "/share/home/lsy_luzhen/WGS_GWAS_and_MR/tmp_ssh_data/VEP/vep_results/allAnnotatedChrs_info_used_v2.rds")
